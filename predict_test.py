...
class TestOutput(unittest.TestCase):
  ...
  def test_generate_augmented_returns_nothing_if_all_same_missing_feature(self):
    X = [[1, 2, MV], [3, 4, MV]]
    y = [5, 6]
  ...
  def test_generate_augmented_only_includes_new_samples(self):
    # The third sample should generate no augmented samples.
    X = [[1, MV, 3], [MV, 5, 6], [MV, MV, 9]]
    y = [10, 11, 12]
    ...
    self.assertListEqual([10, 11], y_augmented)
